...
% Calcular la media y el intervalo de confianza del 95 Tasa (2,4)%
...
% Calcular la media y el intervalo de confianza del 95 Tasa (4,4)%
...
% Calcular la media y el intervalo de confianza del 95 Tasa (6,4)%
...
% Calcular la media y el intervalo de confianza del 95 Tasa (8,4)%
...
% Calculate uncoded block error rate (R=k/n=1)
qamBER = berawgn(EbNodB,'qam',16,'nondiff');
